...
import { VaultEntry } from '../../models/terraformars.models';
...
export class CategoryDetail {
  ...
  private readonly editItemService = inject(TerraformarsItemEditService);
  private readonly crud = inject(TerraformarsCrudService);
  private readonly dialogCard = inject(DialogCardService);
  private readonly opFeedback = inject(TerraformarsFeedbackService);
  ...
  private readonly createImageContainer = viewChild<ElementRef<HTMLDivElement>>('createImageContainer');
  ...
  protected initCrop(): void {
    ...
    const ratios = CROP_RATIOS.itemCard;
