...
export { routes as consoleRoutes } from '../../features/menus/routes/console.routes';  
...
export { routes as terraformarsRoutes } from '../features/terraformars/routes/terraformars.routes';
export { routes as userRoutes } from '../features/user/routes/user.routes';
